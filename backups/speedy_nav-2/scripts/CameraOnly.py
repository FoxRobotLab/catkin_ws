...
class ImageSensor():
	...
	def image_callback(self, data):
		...
		sectionWidth = width / 30
		sectionHeight = height / 5
		# box = c,r,w,h
		leftBox = sectionWidth * 10, sectionHeight * 2, sectionWidth, sectionHeight
		rightBox = sectionWidth * 19, sectionHeight * 2, sectionWidth, sectionHeight
