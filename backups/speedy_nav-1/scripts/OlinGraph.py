...
# The node data is using the same coordinates as the WorldyRobot,
...
# 2) East T:  Lab hall, Libby's lab hall, PC lab hall, 250 center hall
olin.addEdge(2, 4)
olin.addEdge(2, 6)
olin.addEdge(2, 10)

# 3) East L:  Lab hall, 247 hall, 250 north hall
olin.addEdge(3, 19)
olin.addEdge(3, 23)
...
# 5) Right Angle door: Libby's lab hall, Right angle center, 232-233 hall
olin.addEdge(5, 30)
olin.addEdge(5, 32)

# 6) PC lab hall: East T, PC lab, Mac lab hall, 250 center hall
olin.addEdge(6, 7)
olin.addEdge(6, 8)
olin.addEdge(6, 10)

# 7) PC lab:  PC lab hall, Mac lab
olin.addEdge(7, 9)

# 8) Mac lab hall: PC lab hall, Mac lab, 250 center hall, 205 center hall,
#                  Reading room hall
olin.addEdge(8, 9)
olin.addEdge(8, 10)
olin.addEdge(8, 11)
...
# 9) Mac lab:  PC lab, Mac lab hall, Reading room
olin.addEdge(9, 12)

# 10) 250 center hall:  East T, PC lab hall, Mac lab hall, Reading room hall
#                       250 center, 205 center hall
olin.addEdge(10, 11)
olin.addEdge(10, 13)
#olin.addEdge(10, 15)
...
# 12) Reading room:  Mac lab, Reading room hall

# 13) 205 center hall:  Mac lab hall, 250 center hall, Reading room hall,
...
# 21) 245 hall: 247 hall, 245 room, 250 north hall, 243 hall
olin.addEdge(21, 22)
olin.addEdge(21, 23)
olin.addEdge(21, 24)
...
# 23) 250 north hall: East L, 250 north, 245 hall, 243 hall, 205 north hall
olin.addEdge(23, 24)
olin.addEdge(23, 26)

# 24) 243 hall:  245 hall, 250 north hall, 243 room, 205 north hall, 241 hall
olin.addEdge(24, 25)
olin.addEdge(24, 26)
olin.addEdge(24, 27)
...
# 26) 205 north hall:  205 east, 250 north hall, 243 hall, 241 hall
olin.addEdge(26, 27)

# 27) 241 hall: 243 hall, 205 north hall, 241 room, Atrium north hall
olin.addEdge(27, 28)
olin.addEdge(27, 29)
...
#	(color1, color2, color3) : (node, angle, targetRelativeArea)
	("red", "blue", "green") : (1, 270.0, 0.14),
	("indigo", "red", "green") : (2, 90.0, 0.14),
	("green", "violet", "blue") : (0, 90.0, 0.14),
	("blue", "green", "red") : (8, 0.0, 0.14),
	("red", "green", "blue") : (11, 0.0, 0.14),
	("blue", "red", "green") : (4, 270.0, 0.14),
	("violet", "green", "red") : (21, 180.0, 0.09),
	("violet", "red", "indigo") : (3, 0.0, 0.09)
}
