...
class OlinTest(object):
    def __init(self):
        ...
        model.summary()
        self.softmax = keras.models.Model(inputs=model.input, outputs=model.get_layer(name="dense_3").output)
    ...
    def test_turtlebot(self, olin_classifier, recent_n_max):#TODO: just initialize robot here, make this class independent from olin_cnn
        ...
        while (not rospy.is_shutdown()):
            ...
            print("{} Predicted Best Cell (N={}): ".format(datetime.now(), len(self.recent_n_cells)), best_cell)
