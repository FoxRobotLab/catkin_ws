...
Paths = namedtuple(
    "Paths",
    ["one_hot_dict_path", "base_path", "train_data_dir", "checkpoint_dir", "train_data_path"]
)
Image = namedtuple(
    "Image",
...
paths = Paths(
    ...
    train_data_path = "/home/jlim2/olri_classifier/0720181135train_data-gray-re1.0-en275-max300-submean.npy",
    one_hot_dict_path = "/home/jlim2/olri_classifier/0720181135train_onehotdict-gray-re1.0-en275-max300-submean.npy"
)
