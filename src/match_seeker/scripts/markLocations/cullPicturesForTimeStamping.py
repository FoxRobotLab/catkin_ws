...
class CullPicturesTimeStamp(object):
    def __init__(self,textFilePath, imageDir, outputFileName, startFileName = "",
    ...
    def modifyTextFile(self):
        """
        Rewrites the text file containing info about framenumber and time so that it does not include the deleted
        frames.
...
if __name__ == "__main__":
    # cullPicture = CullPicturesTimeStamp(imageDir="/home/macalester/PycharmProjects/catkin_ws/src/match_seeker/scripts/markLocations/juneElevenFrames/",
