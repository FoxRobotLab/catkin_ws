...
def clean_image(image, data = 'old', cell = None, heading = None):
    mean = np.load(pathToMatchSeeker + 'res/classifier2019data/DATA/SAMPLETRAINING_100_500_mean135k.npy')   #TRAININGDATA_100_500_mean95k.npy')
    image_size = 100
...
if __name__ == "__main__":
    ...
    print(olin_classifier.runSingleImage(1, input='cell'))
