...
class CellPredictorRGB(object):
    ...
    def testOneCell(self, cell, framesList):
        ...
        :return:
            perfMap: Map of perfectly predicted test cases, cell number as keys and list of perfectly predicted frames as values
        ...
        return perfMap, failedMap, frameProbability, frameTop3PredProb
