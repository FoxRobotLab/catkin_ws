...
class monteCarloLoc():
    ...
    #         (posX, posY, posAngle) = part.getLoc()
    #         while True:
    ...
    #             newY = posY + deltaY
    #
    #             newParticle = Particle(newX, newY, newAngle)
    ...
    #
    #             if self.isValid(newParticle):
    #                 addList.append(newParticle)
    #                 break
    #     return addList
        ...
        for idx, count in enumerate(list_idx_choices):
            ...
            while count > 0:
                ...
                if count == 1:
                    ...
                    newParticle = self.addNormParticles(currParticle)
